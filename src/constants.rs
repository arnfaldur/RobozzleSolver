...
pub(crate) const TILE_TOUCH_MASK: Tile = Tile(0b1111111111110000);
...
pub(crate) const PUZZLE_42_SOLUTION: Source = Source([
    [F2, LEFT, F3, LEFT, F1, HALT, HALT, HALT, HALT, HALT],
    [F3, F3, HALT, HALT, HALT, HALT, HALT, HALT, HALT, HALT],
    [F4, F4, HALT, HALT, HALT, HALT, HALT, HALT, HALT, HALT],
    [
        FORWARD, FORWARD, HALT, HALT, HALT, HALT, HALT, HALT, HALT, HALT,
    ],
    [HALT; 10],
]);
...
pub(crate) const PUZZLE_536_SOLUTION: Source = Source([
    [F2, RIGHT, F1, HALT, HALT, HALT, HALT, HALT, HALT, HALT],
    [
        FORWARD, BLUE_F2, FORWARD, HALT, HALT, HALT, HALT, HALT, HALT, HALT,
    ],
    [HALT; 10],
    [HALT; 10],
    [HALT; 10],
...
pub(crate) const PUZZLE_656_SOLUTION: Source = Source([
    [LEFT, F2, LEFT, FORWARD, F1, HALT, HALT, HALT, HALT, HALT],
    [
        FORWARD, RED_RIGHT, RED_RIGHT, BLUE_F2, FORWARD, HALT, HALT, HALT, HALT, HALT,
    ],
    [HALT; 10],
    [HALT; 10],
    [HALT; 10],
    ...
    REJECTS_3
        .set(
            [
                ...
                [MARK_RED, RED_LEFT, RED_MARK_GREEN],
                [MARK_RED, RED_LEFT, RED_MARK_BLUE],
                [MARK_RED, RED_RIGHT, RED_MARK_GREEN],
                [MARK_RED, RED_RIGHT, RED_MARK_BLUE],
                [MARK_GREEN, GREEN_LEFT, GREEN_MARK_RED],
                [MARK_GREEN, GREEN_LEFT, GREEN_MARK_BLUE],
                [MARK_GREEN, GREEN_RIGHT, GREEN_MARK_RED],
                [MARK_GREEN, GREEN_RIGHT, GREEN_MARK_BLUE],
                [MARK_BLUE, BLUE_LEFT, BLUE_MARK_RED],
                [MARK_BLUE, BLUE_LEFT, BLUE_MARK_GREEN],
                [MARK_BLUE, BLUE_RIGHT, BLUE_MARK_RED],
                [MARK_BLUE, BLUE_RIGHT, BLUE_MARK_GREEN],
                [RED_LEFT, MARK_RED, RED_LEFT],
                [RED_LEFT, MARK_GREEN, GREEN_LEFT],
                [RED_LEFT, MARK_BLUE, BLUE_LEFT],
                ...
                [RED_RIGHT, MARK_RED, RED_RIGHT],
                [RED_RIGHT, MARK_GREEN, GREEN_RIGHT],
                [RED_RIGHT, MARK_BLUE, BLUE_RIGHT],
                ...
                [GREEN_LEFT, MARK_RED, RED_LEFT],
                [GREEN_LEFT, MARK_RED, RED_RIGHT],
                [GREEN_LEFT, MARK_GREEN, GREEN_LEFT],
                [GREEN_LEFT, MARK_GREEN, GREEN_RIGHT],
                [GREEN_LEFT, MARK_BLUE, BLUE_LEFT],
                [GREEN_LEFT, MARK_BLUE, BLUE_RIGHT],
                [GREEN_LEFT, RED_MARK_GREEN, GREEN_RIGHT],
                [GREEN_LEFT, RED_MARK_BLUE, GREEN_MARK_RED],
                [GREEN_LEFT, RED_MARK_BLUE, BLUE_LEFT],
                [GREEN_LEFT, GREEN_MARK_RED, RED_RIGHT],
                [GREEN_LEFT, GREEN_MARK_BLUE, BLUE_RIGHT],
                [GREEN_LEFT, BLUE_LEFT, MARK_RED],
                [GREEN_LEFT, BLUE_LEFT, MARK_GREEN],
                [GREEN_LEFT, BLUE_LEFT, MARK_BLUE],
                ...
                [GREEN_RIGHT, MARK_RED, RED_LEFT],
                [GREEN_RIGHT, MARK_RED, RED_RIGHT],
                [GREEN_RIGHT, MARK_GREEN, GREEN_LEFT],
                [GREEN_RIGHT, MARK_GREEN, GREEN_RIGHT],
                [GREEN_RIGHT, MARK_BLUE, BLUE_LEFT],
                [GREEN_RIGHT, MARK_BLUE, BLUE_RIGHT],
                [GREEN_RIGHT, RED_MARK_GREEN, GREEN_LEFT],
                [GREEN_RIGHT, RED_MARK_BLUE, GREEN_MARK_RED],
                [GREEN_RIGHT, RED_MARK_BLUE, BLUE_RIGHT],
                [GREEN_RIGHT, GREEN_MARK_RED, RED_LEFT],
                [GREEN_RIGHT, GREEN_MARK_BLUE, BLUE_LEFT],
                [GREEN_RIGHT, BLUE_RIGHT, MARK_RED],
                [GREEN_RIGHT, BLUE_RIGHT, MARK_GREEN],
                [GREEN_RIGHT, BLUE_RIGHT, MARK_BLUE],
                ...
                [BLUE_LEFT, MARK_RED, RED_LEFT],
                [BLUE_LEFT, MARK_RED, RED_RIGHT],
                [BLUE_LEFT, MARK_GREEN, GREEN_LEFT],
                [BLUE_LEFT, MARK_GREEN, GREEN_RIGHT],
                [BLUE_LEFT, MARK_BLUE, BLUE_LEFT],
                [BLUE_LEFT, MARK_BLUE, BLUE_RIGHT],
                [BLUE_LEFT, RED_MARK_GREEN, GREEN_LEFT],
                [BLUE_LEFT, RED_MARK_GREEN, GREEN_RIGHT],
                [BLUE_LEFT, RED_MARK_GREEN, BLUE_MARK_RED],
                [BLUE_LEFT, RED_MARK_BLUE, BLUE_RIGHT],
                [BLUE_LEFT, GREEN_MARK_RED, RED_LEFT],
                [BLUE_LEFT, GREEN_MARK_RED, RED_RIGHT],
                [BLUE_LEFT, GREEN_MARK_RED, BLUE_MARK_GREEN],
                [BLUE_LEFT, GREEN_MARK_BLUE, BLUE_RIGHT],
                [BLUE_LEFT, BLUE_MARK_RED, RED_RIGHT],
                [BLUE_LEFT, BLUE_MARK_GREEN, GREEN_RIGHT],
                [BLUE_RIGHT, MARK_RED, RED_LEFT],
                [BLUE_RIGHT, MARK_RED, RED_RIGHT],
                [BLUE_RIGHT, MARK_GREEN, GREEN_LEFT],
                [BLUE_RIGHT, MARK_GREEN, GREEN_RIGHT],
                [BLUE_RIGHT, MARK_BLUE, BLUE_LEFT],
                [BLUE_RIGHT, MARK_BLUE, BLUE_RIGHT],
                [BLUE_RIGHT, RED_MARK_GREEN, GREEN_LEFT],
                [BLUE_RIGHT, RED_MARK_GREEN, GREEN_RIGHT],
                [BLUE_RIGHT, RED_MARK_GREEN, BLUE_MARK_RED],
                [BLUE_RIGHT, RED_MARK_BLUE, BLUE_LEFT],
                [BLUE_RIGHT, GREEN_MARK_RED, RED_LEFT],
                [BLUE_RIGHT, GREEN_MARK_RED, RED_RIGHT],
                [BLUE_RIGHT, GREEN_MARK_RED, BLUE_MARK_GREEN],
