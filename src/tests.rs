...
mod tests {
    ...
    fn test_puzzle_536_instruction_set() {
        assert_eq!(vec![
            ...
            BLUE_F1,
            BLUE_F2,
        ], PUZZLE_536.get_ins_set(INS_COND_MASK, true));
    }
    ...
    fn test_puzzle_656_instruction_set() {
        assert_eq!(vec![
            ...
            BLUE_F1,
            BLUE_F2,
        ], PUZZLE_656.get_ins_set(INS_COND_MASK, true));
    }
    ...
    fn test_puzzle_1337_instruction_set() {
        assert_eq!(vec![
            ...
            BLUE_MARK_RED,
            BLUE_MARK_GREEN,
        ], PUZZLE_1337.get_ins_set(INS_COND_MASK, true));
    }
    ...
    fn test_puzzle_test_1_instruction_set() {
        assert_eq!(vec![
            ...
            BLUE_MARK_RED,
            BLUE_MARK_GREEN,
        ], PUZZLE_TEST_1.get_ins_set(INS_COND_MASK, true));
    }
...
//            print!("{}", show_instruction(instruction));
//        }
        let instruction_set = PUZZLE_42.get_ins_set(INS_COND_MASK, true);
...
//    }
    ...
    fn bench_execute_536_times_10(b: &mut Bencher) {
        let instruction_set = PUZZLE_536.get_ins_set(INS_COND_MASK, true);
...
//    }
    ...
    fn bench_execute_656_times_10(b: &mut Bencher) {
        let instruction_set = PUZZLE_656.get_ins_set(INS_COND_MASK, true);
