...
mod tests {
    ...
    fn test_puzzle_536_instruction_set() {
        assert_eq!(vec![
            ...
            BLUE_F1,
            BLUE_F2,
        ], PUZZLE_536.get_instruction_set());
    }
    ...
    fn test_puzzle_656_instruction_set() {
        assert_eq!(vec![
            ...
            BLUE_F1,
            BLUE_F2,
        ], PUZZLE_656.get_instruction_set());
    }
    ...
    fn test_puzzle_test_1_instruction_set() {
        assert_eq!(vec![
            ...
            BLUE_MARK_GREEN,
            BLUE_MARK_BLUE,
        ], PUZZLE_TEST_1.get_instruction_set());
    }
...
//            print!("{}", show_instruction(instruction));
//        }
        let instruction_set = PUZZLE_42.get_instruction_set();
        ...
        for iteration in 0..10 {
            ...
            b.iter(|| PUZZLE_42.execute(&source, carlo::score));
        }
    }

    #[bench]
    fn bench_execute_42_solution(b: &mut Bencher) {
        b.iter(|| PUZZLE_42.execute(&PUZZLE_42_SOLUTION, carlo::score));
    }
...
//    }
    ...
    fn bench_execute_536_times_10(b: &mut Bencher) {
        let instruction_set = PUZZLE_536.get_instruction_set();
        ...
        for _iteration in 0..10 {
            ...
            b.iter(|| PUZZLE_536.execute(&source, carlo::score));
        }
    }

    #[bench]
    fn bench_execute_536_solution(b: &mut Bencher) {
        b.iter(|| PUZZLE_536.execute(&PUZZLE_536_SOLUTION, carlo::score));
    }
...
//    }
    ...
    fn bench_execute_656_times_10(b: &mut Bencher) {
        let instruction_set = PUZZLE_656.get_instruction_set();
        ...
        for _iteration in 0..10 {
            ...
            b.iter(|| PUZZLE_656.execute(&source, carlo::score));
        }
    }

    #[bench]
    fn bench_execute_656_solution(b: &mut Bencher) {
        b.iter(|| PUZZLE_656.execute(&PUZZLE_656_SOLUTION, carlo::score));
    }
